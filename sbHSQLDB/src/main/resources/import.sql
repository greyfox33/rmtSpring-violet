...
create table statusUpdate (status_id int not null primary key, caseid int, statusUpdate varchar(250), createDate timestamp, modifyDate timestamp, deleted int );
...
insert into statusUpdate (status_id, case_id, statusUpdate, createDate) values (50, 1000, 'this is the first status update for this case. Jim is doing well', now());
insert into statusUpdate (status_id, case_id, statusUpdate,  createDate) values (51, 1000, 'this is the second status update for this case. Jim is doing well', now());